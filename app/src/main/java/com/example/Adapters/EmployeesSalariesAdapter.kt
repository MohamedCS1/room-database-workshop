...
class EmployeesSalariesAdapter(private var listemployees: List<Employee>, viewModel: DataViewModel?):RecyclerView.Adapter<EmployeesSalariesAdapter.EmployeesSalariesViewHolder>() {
